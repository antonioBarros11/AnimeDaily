    ...
    <header className="flex flex-col w-full py-4 px-2 relative">
      ...
      {showLogin && (
        ...
        >
          <div
            ref={loginRef}
            className="h-[300px] w-[300px] bg-[#5925DC] rounded-b-2xl shadow-lg"
          >
            <div className="flex flex-col items-center pt-10 gap-4">
              ...
              <button
                onClick={handleLogin}
                className="text-[#5925DC] font-bold bg-[#D9D9D9] rounded-full px-4 py-2"
              >
                Iniciar sesión
              </button>
            </div>
      ...
      {showSignup && (
        ...
        >
          <div
            ref={signupRef}
            className="h-[350px] w-[300px] bg-[#5925DC] rounded-b-2xl shadow-lg"
          >
            <div className="flex flex-col items-center pt-10 gap-4">
              <div className="flex gap-2 items-center">
                <img src="/logoLogin.png" alt="Logo" />
